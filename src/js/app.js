document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateDOM = (data) => {
        ...
        weatherCard.innerHTML = `
            <h2>${data.name}</h2>
            <img class="weather-anim" src="assets/icons/${weather[0].icon}.png" alt="${weather[0].description}" onerror="this.onerror=null;this.src='weatherly/src/assets/icons/04n.png';">
